...
const numberIsIncluded = numbers.includes(numberToCheck, 5);
...
// const stringsLowerCase = strings.map((string) => {
//   return string.toLowerCase();
// });

// const stringToCheck = "html";
// const stringIsIncluded = stringsLowerCase.includes(stringToCheck.toLowerCase());
// stringOutput.textContent = stringIsIncluded
//   ? `Yes, ${stringToCheck} is included!`
//   : `No, ${stringToCheck} is not included!`;
...
const objectToFind = simpsons.find((simpson) => simpson.age === 42);
